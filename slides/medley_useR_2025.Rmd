...
For methods 1, 2, and 4 we will use both logistic regression and random forests with each of these approaches  
...
* Yet another confusion matrix function [`confusion_matrix`](https://jbryer.github.io/medley/reference/confusion_matrix.html).
